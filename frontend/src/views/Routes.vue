...
// 本地 mock 路线生成
// 为了避免每次生成都高度雷同，按地点类别准备多套文案池并随机抽取
const mockPools = {
  // ============ 博物馆类 ============
  '博物馆': {
    desc: [
      '走进这座专题博物馆，等于翻开了一部中国红十字运动的立体史书。从战地救护到灾后重建，从博爱恤民到国际人道法，每个展厅都在用实物与影像讲述一段不应被遗忘的故事。',
      '与其说是一座博物馆，不如说是一所没有围墙的人道主义课堂。馆藏的多份珍贵文献与老照片，是研究近代中国慈善史的一手材料。',
      '馆内把抽象的『人道、博爱、奉献』翻译成可触摸的实物与场景，让第一次接触红十字文化的访客也能在两小时内建立基本认知框架。',
    ],
    history: [
      '场馆前身可追溯至上世纪三十年代，记录了近代上海作为远东慈善枢纽的黄金年代。',
      '建馆过程中得到了多位红十字先辈后人捐赠的实物，使得馆藏兼具历史厚度与情感温度。',
    ],
    highlights: [
      '序厅的『百年红十字』浮雕墙是镇馆之作',
      '二楼的战地救护实景复原区',
      'AR 互动体验：亲手组装一副老式担架',
      '尾厅的志愿者笑脸墙，收集了上千张笑脸照片',
    ],
    photoSpots: [
      '序厅浮雕墙前的留影角',
      '中庭的红十字主题玻璃穹顶',
    ...
    nearbyFood: '出门左转进入 XX 路，沿街有几家老字号本帮菜馆；马路对面则是连锁咖啡与轻食店，适合休息补给。',
    practicalTips: [
      '馆内冷气偏足，夏天建议带一件薄外套',
      '讲解器可在服务台免费租借，押金 100 元',
      '每周三上午 10:00 有志愿者免费讲解',
      '二楼有母婴室与无障碍电梯',
    ],
  },
  // ============ 机构类 ============
  '机构': {
    desc: [
      '这里不仅是行政办公地，更像是一扇面向公众的『红十字之窗』：志愿者注册、救护培训、献血预约、应急救援咨询都能一站搞定。',
      '作为城市层面的红十字会机构，它承担着整合社会爱心、对接各类救助资源的中枢角色。',
      '对希望参与志愿服务或了解公益项目运作的访客来说，这里比任何一个展馆都更『活』——因为每天都有真实的人道故事从这里发出。',
    ],
    history: [
      '上海市红十字会成立于 1904 年，是中国最早的城市级红十字组织之一。',
      '新中国成立后，机构几经整合，逐步发展为今天兼具救助、培训、对外联络功能的综合性人道平台。',
    ],
    highlights: [
      '一楼大厅的『爱心捐赠墙』可以留下自己的祝福',
      '志愿者之家：实时滚动显示各类志愿活动报名人数',
      '应急救护培训教室可旁观正在进行的 CPR 训练',
      '会议室外的『十年大事记』走廊',
    ],
    photoSpots: [
      '门厅的红十字会徽大理石浮雕',
    ...
    nearbyFood: '机构周边有多个商务楼食堂对外开放，午餐时段 30 元左右可吃得很饱；附近咖啡店也很多。',
    practicalTips: [
      '工作日 9:00-17:00 对外开放，周末仅接待预约访客',
      '若想旁观救护培训课程需提前 3 天电话预约',
      '可现场填写志愿者登记表',
      '停车位紧张，建议公共交通出行',
    ],
  },
  ...
  '救灾中心': {
    desc: [
      '物资从入仓到发出不超过 48 小时，这里是中国红十字会系统响应速度最快的备灾中心之一。',
      '对普通访客来说，参观救灾中心能直观理解『人道救援』背后的物流与协作链条。',
      '中心兼具储备、调拨、培训三重功能——既是一座『仓库』，也是一所『学校』，更是一支随时可以出发的『队伍』。',
    ],
    history: [
      '中心始建于上世纪九十年代，2008 年汶川地震后大规模扩建，承担起华东地区重大灾害的应急物资保障任务。',
      '多次在国际国内重大灾害中作为『第一响应』的物资中转站。',
    ],
    highlights: [
      '可亲手触摸救灾帐篷、家庭包等核心物资',
      '调度中心大屏实时显示各仓库物资余量',
    ...
    nearbyFood: '园区食堂对外开放，凭访客证即可用餐；周边高速服务区也可作为备选。',
    practicalTips: [
      '需提前 5 个工作日提交单位介绍信预约',
      '访客通道与作业区严格分离，请勿跨越黄线',
      '现场禁止使用闪光灯，影响仓储扫码作业',
  ...
  '医疗机构': {
    desc: [
      '秉承红十字人道主义精神的医疗机构，把『救死扶伤』四个字落到了流程的每一个细节。',
      '从院前急救到重大公共卫生事件响应，这家医院始终是上海医疗体系中的『红十字担当』。',
      '对希望了解现代医疗如何嵌入人道关怀的访客，这里既是窗口，也是课堂。',
    ],
    history: [
      '前身为上世纪的教会医院，1950 年代由红十字会接管，逐渐发展为集医疗、教学、科研于一体的综合医院。',
      '在多次重大公共卫生事件中承担定点收治任务。',
    ],
    highlights: [
      '院史馆珍藏百年病历与手术器械',
      '急诊大厅的『时间就是生命』雕塑',
    ...
    nearbyFood: '医院周边有多个面馆与便利店，24 小时不打烊；马路对面有商场餐饮区，品类齐全。',
    practicalTips: [
      '院史馆周一闭馆',
      '门诊区域请勿大声喧哗',
      '停机坪参观仅在非急救时段开放',
  ...
  '国际组织': {
    desc: [
      '这里是国际人道法在中国推广的重要节点，也是国际组织与本地合作伙伴沟通的桥梁。',
      '相比其他『看展式』参访，这里更像一个『对话场』——访客有机会接触到真实的国际人道项目。',
      '如果你对国际组织运作感兴趣，这里的图书馆、会议室与项目展示区都是绝佳的观察窗口。',
    ],
    history: [
      '代表处设立以来，长期致力于推动国际人道法在中国的研究、教学与传播。',
      '多次作为东亚地区人道工作协调的枢纽机构。',
    ],
    highlights: [
      '图书馆藏有大量国际人道法原版文献',
    ...
    nearbyFood: '位于市中心商圈周边，西餐、咖啡、轻食选择丰富，人均 60-100 元。',
    practicalTips: [
      '需提前邮件预约并提供身份证件',
      '内部资料区域禁止拍照',
      '员工咖啡区可与工作人员自由交流',
  ...
  '纪念公园': {
    desc: [
      '与其说是一座公园，不如说是一座『开放式纪念馆』——纪念碑、雕塑、广场在绿意中静静诉说着红十字精神。',
      '非常适合家庭出游、志愿者团建以及任何想找个安静角落感受人道主义氛围的人。',
      '公园内多处设置了可参与的公益装置，例如『承诺墙』『心愿树』，让普通游客也能成为人道行动的一分子。',
    ],
    history: [
      '为纪念中国红十字运动重要历史节点而建，是上海为数不多以『博爱』为主题的开放式纪念空间。',
      '园内的红十字纪念碑由多位国际友人共同揭幕。',
    ],
    highlights: [
      '中央广场的红十字纪念碑',
      '『承诺墙』上可留下自己的公益承诺',
    ...
    nearbyFood: '公园南门外的商业街有各类餐饮小店；西门有亲子餐厅与简餐。',
    practicalTips: [
      '建议春秋季前往，避开正午暴晒',
      '可自带野餐垫在草坪区休憩',
      '园内有共享充电宝租借点',
  ...
  '默认': {
    desc: [
      '作为上海红十字文化版图中的重要一站，它以一种独特的方式记录并延续着人道主义传统。',
      '来这里不一定要看『展品』，更多是感受一种贯穿城市日常的善意氛围。',
      '推荐给所有对人道主义、城市公益感兴趣的人，你会发现熟悉的城市原来还有这样温柔的一面。',
    ],
    history: [
      '其历史可追溯至近代上海作为远东慈善枢纽的时期。',
      '见证了红十字精神在上海的本土化实践。',
    ],
    highlights: [
      '常年举办红十字主题临时展览',
    ...
    nearbyFood: '周边街区选择丰富，从本帮菜到西式简餐一应俱全，人均 40-80 元。',
    practicalTips: [
      '建议工作日前往，人流较少',
      '公共交通最为便利',
      '部分展厅禁止使用闪光灯',
...
const generateMockRoute = (question) => {
  ...
  const steps = picked.map((loc, idx) => {
    const pool = mockPools[loc.category] || mockPools['默认']
    return {
      name: loc.name,
      meta: `预计参观 ${40 + idx * 10} 分钟（${loc.category}）`,
      desc: pickRandom(pool.desc) + ' ' + loc.description,
      history: pickRandom(pool.history),
      best_time: isKids
        ? '周末上午 10:00-12:00 最佳，孩子精力充沛、互动项目齐全。'
        : isMedical
          ? '建议工作日下午 14:00-16:00，人流相对较少。'
          : '工作日上午 9:30-11:30 最佳，团队参观较少，可以安静观展。',
      ticket: '免费开放，无需购票。建议提前通过官方公众号预约；部分场馆每周一闭馆维护。',
      highlights: pool.highlights,
      photo_spots: pool.photoSpots,
      nearby_food: pool.nearbyFood,
      practical_tips: pool.practicalTips,
      tips: [
        pickRandom(['请遵守场馆规定，勿使用闪光灯拍照', '部分展品需预约才能近距离观看', '馆内禁止饮食', '可使用讲解器，更深入了解展品背后的故事']),
        pickRandom(['可关注官方公众号获取最新活动信息', '停车不便，建议公共交通', '馆内设有无障碍通道', '周边餐饮选择丰富']),
      ],
    }
  })
  ...
  const processVariants = [
    `首先根据您的提问（"${question || '默认推荐'}"）识别主题与可用时间，从地点库中按主题相关性挑选了 ${picked.length} 个代表性场馆；接着按主题连续性与参观节奏由浅入深地排列浏览顺序，避免主题重复并保持体验连贯；然后估算每站参观时长，确保总耗时与您的时间相匹配；最后补充参观亮点、餐饮与拍照点等实用信息，方便落地执行。`,
    `这次路线生成的思路如下：先解构您的需求（"${question || '默认推荐'}"），拆出主题、时间、兴趣三要素；再从地点库中按契合度打分，挑出得分最高的 ${picked.length} 个点；随后设计一条『由抽象到具象』『由历史到当下』的参观动线；最后用附近餐饮、拍照机位、实用贴士把整条路线『包圆』，让您拿起来就能用。`,
    `为您规划时考虑了三个维度：①主题契合度，确保每个馆都与您的兴趣相关；②节奏合理性，避免长途奔波；③信息完整性，把参观时间、餐饮、拍照点都打包好。这次共挑选了 ${picked.length} 个地点，按主题递进的方式串成完整动线。`,
  ]
  const process = pickRandom(processVariants)
